...
public class flame_atc : MonoBehaviour
{
    ...
    // Nova fun��o para clonar/spawn ataque bola_de_fogo
    void AddEnemy()
    {
        // Criar uma serra
        Instantiate(bola_de_fogo, exit_flame.transform.position, Quaternion.identity);
    }
    // Fun��o para destruir flame_atc, depois de 2 ataques, contador de pontos, e audio quando flame_atc perde vida
